...
module @softmax {
  func.func @test(%arg0: memref<32x256xf32>) -> memref<32x256xf32> {
    ...
    scf.parallel (%arg1) = (%c0_1) to (%c32) step (%c1) {
      scf.parallel (%arg2) = (%c0_2) to (%c1) step (%c1) {
        %0 = arith.addi %c0, %arg2 : index
        %1 = vector.transfer_read %arg0[%arg1, %0], %cst_0 {in_bounds = [true], mode = "simd"} : memref<32x256xf32>, vector<16xf32>
        %2 = vector.reduction <maxf>, %1 : vector<16xf32> into f32
        %4 = vector.broadcast %2 : f32 to vector<16xf32>
        %5 = arith.subf %1, %4 : vector<16xf32>
        %6 = math.exp %5 : vector<16xf32>
        %7 = vector.reduction <add>, %6 : vector<16xf32> into f32
        %9 = vector.broadcast %7 : f32 to vector<16xf32>
        %10 = arith.divf %6, %9 : vector<16xf32>
        %11 = arith.addi %c0, %arg2 : index
        vector.transfer_write %10, %alloc[%arg1, %11] {in_bounds = [true], mode = "simd"} : vector<16xf32>, memref<32x256xf32>
        scf.yield
      }
      scf.yield
    }
